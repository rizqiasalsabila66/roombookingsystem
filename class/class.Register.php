<?php
    ...
    class Register extends Connection{
        ...
        public function AddMember(){
            $this->connect();
            $sql = "INSERT INTO userruangan (nama, email, password, alamat, role, instansi, noTelp, gender)
                    VALUES ('$this->nama','$this->email', '$this->password', '$this->alamat', '$this->role', '$this->instansi', '$this->noTelp', '$this->gender')";
        ...
        public function SelectAllMember(){
            ...
            if (mysqli_num_rows($result) > 0) {
                while($data = mysqli_fetch_array($result)){
                    ...
                    $objRegister->instansi = $data['instansi'];
