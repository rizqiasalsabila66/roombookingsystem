<?php
    ...
    class Admin extends Connection{
        ...
        public function AddAdmin(){
            ...
            $sql = "INSERT INTO `admin` (nama, UserID) VALUES ('$this->nama','$UserID')";
        ...
        public function SelectAllAdmin(){
         ...
         public function CariAdmin(){
            $this->connect();
            $sql = "SELECT * from userruangan where nama like '%".$kata_kunci."%' or alamat like '%".$kata_kunci."%' or role like '%".$kata_kunci."%' order by UserID asc'";
            $this->hasil = mysqli_query($this->connection, $sql);
