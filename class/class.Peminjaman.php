...
class Peminjaman_Ruangan extends Connection{
    ...
    public function AddPeminjaman(){
        $this->connect();
        $sql = "INSERT INTO peminjaman_ruangan (jamPinjam, lamaPinjam, jamSelesai, keperluan, tambahan,  tglSelesai, tglPinjam, UserID, IDRuangan)
                VALUES ('$this->jamPinjam', '$this->lamaPinjam','$this->jamSelesai', '$this->keperluan', '$this->tambahan', '$this->tglSelesai', '$this->tglPinjam', '$this->UserID', '$this->IDRuangan')";
    ...
    public function SelectAllPeminjamanUser(){
        ...
        if(mysqli_num_rows($result) > 0){
            while ($data = mysqli_fetch_array($result)){
                ...
                $objPeminjaman->tambahan=$data['tambahan'];
