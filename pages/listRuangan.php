<div class="container">
    <div class="wrapper">
        ...
        <div class="Title">
            ...
            <h3 class="Title">Daftar Ruangan yang Sudah Dipinjam</h3>
                ...
                <?php
                    ...
                    if(count($arrayResult) == 0){
                        ...
                        foreach ($arrayResult as $dataRuangan) {
                            ...
                            echo '<li>Keterangan: '.$dataRuangan->ket_ruangan.'</li>';
                            echo '</ul>';
                            echo '<a class="btn btn-primary btn-block mb-1" href="dashboardUser.php?p=formPinjam&IDRuangan='.$dataRuangan->IDRuangan.'&namaRuangan='.$dataRuangan->namaRuangan.'" role="button"><i class="fas fa-door-open"></i> Book</a>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
