<?php ob_start();
    ...
    $year = date("Y");
    $judul = 'Laporan Data User Peminjaman Gedung Demak '.$year;
    ...
    $content.= '<tr>
                    ...
                    <th style="background-color: #007bff; color: white; padding: 10px;">Instansi</th>
    ...
    if (count($arrayResult) == 0) {
        ...
        foreach($arrayResult as $dataUser){
            if ($dataUser->role == 'Mahasiswa' OR $dataUser->role == 'Dosen') {
                ...
                $content.= '<td style="border: 1px solid #ddd; padding: 10px;">'.$dataUser->instansi.'</td>';
