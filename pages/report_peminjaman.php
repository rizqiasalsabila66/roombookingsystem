<?php ob_start();
    ...
    $year = date("Y");
    $judul = 'Laporan Data Peminjaman Gedung Demak '.$year;
    ...
    $content.= '<tr>
                    ...
                    <th style="background-color: #007bff; color: white; padding: 10px;">Keperluan</th>
    ...
    if (count($arrayResult) == 0) {
        ...
        foreach($arrayResult as $dataPeminjaman){
            if ($dataPeminjaman->role != 'Admin') {
                ...
                $content.= '<td style="border: 1px solid #ddd; padding: 10px; white-space: nowrap; overflow: hidden; width: 70px; text-overflow: ellipsis; table-layout: fixed;">'.$dataPeminjaman->keperluan.'</td>'; 
