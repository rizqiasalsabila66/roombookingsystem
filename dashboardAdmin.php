...
<head>
    ...
    <body>
        <nav class="navbar navbar-expand-sm navbar-light bg-white text-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="dashboardAdmin.php?p"><strong>Sistem Sewa Gedung</strong></a>
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="dashboardAdmin.php?p=adminListArsipPeminjaman">Arsip Peminjaman</a>
                    </li>
                </ul>
                        ...
                        <ul class="navbar-nav ml-auto nav-flex-icons">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
                                    ...
                                    <hr>
                                    <a class="dropdown-item" href='dashboardMahasiswa.php?p=updateAkun&UserID=<?php echo $_SESSION["UserID"]?>'><i class="fas fa-user-circle"></i> Akun </a>
